...
df <- readr::read_csv2(
  "/home/onyxia/formation-Bonnes-Pratiques/individu_reg.csv",
...
print(summarise(df2,length(unique(unlist(cs2[!is.na(cs2)])))))
      ...
      ggplot(df2[as.numeric(df2$aged) > 50,c(3,4)], aes(
        ...
        y = after_stat(density), fill = factor(decennie_a_partir_annee(as.numeric(aemm)))), alpha = 0.2) + geom_histogram()#position = "dodge") + scale_fill_viridis_d()
      ...
      dir.create("/home/onyxia/formation-Bonnes-Pratiques/output")
      setwd("/home/onyxia/formation-Bonnes-Pratiques/output")
